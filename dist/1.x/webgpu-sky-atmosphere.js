...
(function (global, factory) {
    ...
    function makeSkyViewUniformParameterizationOverrides(uniformParameterizationConfig) {
    ...
    class SkyViewLutPipeline {
        ...
        static makePipelineDescriptor(device, bindGroupLayout, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize, distanceToMaxSampleCount, fromKilometersScaleFactor, useMoon, uniformParameterizationConfig, shadowConfig, customUniformsConfig, miePhaseConfig) {
            return {
                label: 'sky view LUT pass',
                layout: device.createPipelineLayout({
                    label: 'sky view LUT pass',
        ...
        static async createAsync(device, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize, distanceToMaxSampleCount, fromKilometersScaleFactor, useMoon, uniformParameterizationConfig, shadowConfig, customUniformsConfig, miePhaseConfig) {
        ...
        static create(device, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize, distanceToMaxSampleCount, fromKilometersScaleFactor, useMoon, uniformParameterizationConfig, shadowConfig, customUniformsConfig, miePhaseConfig) {
            const bindGroupLayout = this.makeBindGroupLayout(device, skyViewLutFormat, customUniformsConfig);
    ...
    class SkyAtmospherePipelines {
        ...
        static async createAsync(device, config) {
            ...
            const transmittanceLutPipeline = TransmittanceLutPipeline.createAsync(device, ...transmittanceLutArgs);
            const multiScatteringLutPipeline = MultiScatteringLutPipeline.createAsync(device, ...multiScatteringLutArgs);
            const skyViewLutPipeline = SkyViewLutPipeline.createAsync(device, ...skyViewLutArgs);
            const aerialPerspectiveLutPipeline = AerialPerspectiveLutPipeline.createAsync(device, ...aerialPerspectiveLutArgs);
        ...
        static create(device, config) {
            ...
            const skyViewLutArgs = this.getSkyViewLutArgs(config);
            const aerialPerspectiveLutArgs = this.getAerialPerspectiveLutArgs(config);
            const transmittanceLutPipeline = TransmittanceLutPipeline.create(device, ...transmittanceLutArgs);
            const multiScatteringLutPipeline = MultiScatteringLutPipeline.create(device, ...multiScatteringLutArgs);
            const skyViewLutPipeline = SkyViewLutPipeline.create(device, ...skyViewLutArgs);
            const aerialPerspectiveLutPipeline = AerialPerspectiveLutPipeline.create(device, ...aerialPerspectiveLutArgs);
