...
(function (global, factory) {
     ...
     */
    function makeEarthAtmosphere(center, yUp = true) {
    ...
    class SkyViewLutPipeline {
        ...
        static makePipelineDescriptor(device, bindGroupLayout, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize, distanceToMaxSampleCount, fromKilometersScaleFactor, useMoon, shadowConfig, customUniformsConfig) {
            return {
                label: 'sky view LUT pass',
                layout: device.createPipelineLayout({
                    label: 'sky view LUT pass',
        ...
        static async createAsync(device, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize, distanceToMaxSampleCount, fromKilometersScaleFactor, useMoon, shadowConfig, customUniformsConfig) {
            const bindGroupLayout = this.makeBindGroupLayout(device, skyViewLutFormat, customUniformsConfig);
            const pipeline = await device.createComputePipelineAsync(this.makePipelineDescriptor(device, bindGroupLayout, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize, distanceToMaxSampleCount, fromKilometersScaleFactor, useMoon, shadowConfig, customUniformsConfig));
            return new SkyViewLutPipeline(device, pipeline, bindGroupLayout, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize);
        }
        static create(device, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize, distanceToMaxSampleCount, fromKilometersScaleFactor, useMoon, shadowConfig, customUniformsConfig) {
            const bindGroupLayout = this.makeBindGroupLayout(device, skyViewLutFormat, customUniformsConfig);
            const pipeline = device.createComputePipeline(this.makePipelineDescriptor(device, bindGroupLayout, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize, distanceToMaxSampleCount, fromKilometersScaleFactor, useMoon, shadowConfig, customUniformsConfig));
            return new SkyViewLutPipeline(device, pipeline, bindGroupLayout, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize);
        }
    ...
    class AerialPerspectiveLutPipeline {
        ...
        static makePipelineDescriptor(device, bindGroupLayout, aerialPerspectiveLutFormat, aerialPerspectiveSliceCount, aerialPerspectiveDistancePerSlice, multiscatteringLutSize, fromKilometersScaleFactor, randomizeSampleOffsets, useMoon, shadowConfig, customUniformsConfig) {
            return {
                label: 'aerial perspective LUT pass',
                layout: device.createPipelineLayout({
                    label: 'aerial perspective LUT pass',
        ...
        static async createAsync(device, aerialPerspectiveLutFormat, aerialPerspectiveSliceCount, aerialPerspectiveDistancePerSlice, multiscatteringLutSize, fromKilometersScaleFactor, randomizeSampleOffsets, useMoon, shadowConfig, customUniformsConfig) {
            const bindGroupLayout = this.makeBindGroupLayout(device, aerialPerspectiveLutFormat, customUniformsConfig);
            const pipeline = await device.createComputePipelineAsync(this.makePipelineDescriptor(device, bindGroupLayout, aerialPerspectiveLutFormat, aerialPerspectiveSliceCount, aerialPerspectiveDistancePerSlice, multiscatteringLutSize, fromKilometersScaleFactor, randomizeSampleOffsets, useMoon, shadowConfig, customUniformsConfig));
        ...
        static create(device, aerialPerspectiveLutFormat, aerialPerspectiveSliceCount, aerialPerspectiveDistancePerSlice, multiscatteringLutSize, fromKilometersScaleFactor, randomizeSampleOffsets, useMoon, shadowConfig, customUniformsConfig) {
            const bindGroupLayout = this.makeBindGroupLayout(device, aerialPerspectiveLutFormat, customUniformsConfig);
            const pipeline = device.createComputePipeline(this.makePipelineDescriptor(device, bindGroupLayout, aerialPerspectiveLutFormat, aerialPerspectiveSliceCount, aerialPerspectiveDistancePerSlice, multiscatteringLutSize, fromKilometersScaleFactor, randomizeSampleOffsets, useMoon, shadowConfig, customUniformsConfig));
            return new AerialPerspectiveLutPipeline(device, pipeline, bindGroupLayout, aerialPerspectiveLutFormat, aerialPerspectiveSliceCount, aerialPerspectiveDistancePerSlice, multiscatteringLutSize);
        }
        makeComputePass(resources, shadowBindGroups, customUniformsBindGroups) {
            if (this.device !== resources.device) {
    ...
    class SkyAtmospherePipelines {
        ...
        static async createAsync(device, config) {
            ...
            const skyViewLutPipeline = SkyViewLutPipeline.createAsync(device, skyViewLutArgs[0], skyViewLutArgs[1], skyViewLutArgs[2], skyViewLutArgs[3], skyViewLutArgs[4], skyViewLutArgs[5], skyViewLutArgs[6], skyViewLutArgs[7]);
            const aerialPerspectiveLutPipeline = AerialPerspectiveLutPipeline.createAsync(device, aerialPerspectiveLutArgs[0], aerialPerspectiveLutArgs[1], aerialPerspectiveLutArgs[2], aerialPerspectiveLutArgs[3], aerialPerspectiveLutArgs[4], aerialPerspectiveLutArgs[5], aerialPerspectiveLutArgs[6], aerialPerspectiveLutArgs[7], aerialPerspectiveLutArgs[8]);
        ...
        static create(device, config) {
            ...
            const skyViewLutPipeline = SkyViewLutPipeline.create(device, skyViewLutArgs[0], skyViewLutArgs[1], skyViewLutArgs[2], skyViewLutArgs[3], skyViewLutArgs[4], skyViewLutArgs[5], skyViewLutArgs[6], skyViewLutArgs[7]);
