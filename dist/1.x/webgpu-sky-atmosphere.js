/* webgpu-sky-atmosphere@1.0.0, license MIT */
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
    typeof define === 'function' && define.amd ? define(['exports'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.webgpuSkyAtmosphere = {}));
     ...
     */
    function makeEarthAtmosphere(scale = 1.0, center, yUp = true) {
        ...
        return {
            ...
            rayleigh: {
                ...
                scattering: [0.005802, 0.013558, 0.033100].map(c => c / scale),
            },
            mie: {
                densityExpScale: -1.0 / mieScaleHeight,
                scattering: [0.003996, 0.003996, 0.003996].map(c => c / scale),
                extinction: [0.004440, 0.004440, 0.004440].map(c => c / scale),
                phaseG: 0.8 * scale,
            },
            absorption: {
                layer0: {
                ...
                extinction: [0.000650, 0.001881, 0.000085].map(c => c / scale),
            },
    ...
    function makeSkyViewLutShaderCode(skyViewLutFormat = 'rgba16float', shadow, customUniforms) {
    ...
    function makeAerialPerspectiveLutShaderCode(aerialPerspectiveLutFormat = 'rgba16float', shadow, customUniforms) {
    ...
    function makeRenderSkyRaymarchingShaderCode(renderTargetFormat = 'rgba16float', shadow, customUniforms) {
        const base = `${constantsWgsl}\n${intersectionWgsl}\n${mediumWgsl}\n${phaseWgsl}\n${uvWgsl}\n${uniformsWgsl}\n${customUniforms ? `${customUniforms}\n${customUniformsWgsl}\n` : ''}${coordinateSystemWgsl}\n${multipleScatteringWgsl}\n${blendWgsl}\n${sunDiskWgsl}\n${fullScreenVertexShaderWgsl}\n${sampleSegmentWgsl}\n`;
    ...
    function makeRenderSkyLutAndRaymarchingShaderCode(renderTargetFormat = 'rgba16float', shadow, customUniforms) {
        const base = `${constantsWgsl}\n${intersectionWgsl}\n${mediumWgsl}\n${phaseWgsl}\n${uvWgsl}\n${uniformsWgsl}\n${customUniforms ? `${customUniforms}\n${customUniformsWgsl}\n` : ''}${coordinateSystemWgsl}\n${multipleScatteringWgsl}\n${skyViewWgsl}\n${blendWgsl}\n${sunDiskWgsl}\n${fullScreenVertexShaderWgsl}\n${sampleSegmentWgsl}\n`;
    ...
    class SkyViewLutPipeline {
        ...
        static makePipelineDescriptor(device, bindGroupLayout, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize, distanceToMaxSampleCount, useMoon, shadowConfig, customUniformsConfig) {
            return {
                label: 'sky view LUT pass',
                layout: device.createPipelineLayout({
                    label: 'sky view LUT pass',
        ...
        static async createAsync(device, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize, distanceToMaxSampleCount, useMoon, shadowConfig, customUniformsConfig) {
            const bindGroupLayout = this.makeBindGroupLayout(device, skyViewLutFormat, customUniformsConfig);
            const pipeline = await device.createComputePipelineAsync(this.makePipelineDescriptor(device, bindGroupLayout, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize, distanceToMaxSampleCount, useMoon, shadowConfig, customUniformsConfig));
            return new SkyViewLutPipeline(device, pipeline, bindGroupLayout, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize);
        }
        static create(device, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize, distanceToMaxSampleCount, useMoon, shadowConfig, customUniformsConfig) {
            const bindGroupLayout = this.makeBindGroupLayout(device, skyViewLutFormat, customUniformsConfig);
            const pipeline = device.createComputePipeline(this.makePipelineDescriptor(device, bindGroupLayout, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize, distanceToMaxSampleCount, useMoon, shadowConfig, customUniformsConfig));
            return new SkyViewLutPipeline(device, pipeline, bindGroupLayout, skyViewLutFormat, skyViewLutSize, multiscatteringLutSize);
        }
    ...
    class AerialPerspectiveLutPipeline {
        ...
        static makePipelineDescriptor(device, bindGroupLayout, aerialPerspectiveLutFormat, aerialPerspectiveSliceCount, aerialPerspectiveDistancePerSlice, multiscatteringLutSize, randomizeSampleOffsets, useMoon, shadowConfig, customUniformsConfig) {
            return {
                label: 'aerial perspective LUT pass',
                layout: device.createPipelineLayout({
                    label: 'aerial perspective LUT pass',
        ...
        static async createAsync(device, aerialPerspectiveLutFormat, aerialPerspectiveSliceCount, aerialPerspectiveDistancePerSlice, multiscatteringLutSize, randomizeSampleOffsets, useMoon, shadowConfig, customUniformsConfig) {
            const bindGroupLayout = this.makeBindGroupLayout(device, aerialPerspectiveLutFormat, customUniformsConfig);
            const pipeline = await device.createComputePipelineAsync(this.makePipelineDescriptor(device, bindGroupLayout, aerialPerspectiveLutFormat, aerialPerspectiveSliceCount, aerialPerspectiveDistancePerSlice, multiscatteringLutSize, randomizeSampleOffsets, useMoon, shadowConfig, customUniformsConfig));
        ...
        static create(device, aerialPerspectiveLutFormat, aerialPerspectiveSliceCount, aerialPerspectiveDistancePerSlice, multiscatteringLutSize, randomizeSampleOffsets, useMoon, shadowConfig, customUniformsConfig) {
            const bindGroupLayout = this.makeBindGroupLayout(device, aerialPerspectiveLutFormat, customUniformsConfig);
            const pipeline = device.createComputePipeline(this.makePipelineDescriptor(device, bindGroupLayout, aerialPerspectiveLutFormat, aerialPerspectiveSliceCount, aerialPerspectiveDistancePerSlice, multiscatteringLutSize, randomizeSampleOffsets, useMoon, shadowConfig, customUniformsConfig));
            return new AerialPerspectiveLutPipeline(device, pipeline, bindGroupLayout, aerialPerspectiveLutFormat, aerialPerspectiveSliceCount, aerialPerspectiveDistancePerSlice, multiscatteringLutSize);
        }
        makeComputePass(resources, shadowBindGroups, customUniformsBindGroups) {
            if (this.device !== resources.device) {
    ...
    class SkyAtmospherePipelines {
        ...
        static async createAsync(device, config) {
            ...
            const skyViewLutPipeline = SkyViewLutPipeline.createAsync(device, skyViewLutArgs[0], skyViewLutArgs[1], skyViewLutArgs[2], skyViewLutArgs[3], skyViewLutArgs[4], skyViewLutArgs[5], skyViewLutArgs[6]);
            const aerialPerspectiveLutPipeline = AerialPerspectiveLutPipeline.createAsync(device, aerialPerspectiveLutArgs[0], aerialPerspectiveLutArgs[1], aerialPerspectiveLutArgs[2], aerialPerspectiveLutArgs[3], aerialPerspectiveLutArgs[4], aerialPerspectiveLutArgs[5], aerialPerspectiveLutArgs[6], aerialPerspectiveLutArgs[7]);
        ...
        static create(device, config) {
            ...
            const skyViewLutPipeline = SkyViewLutPipeline.create(device, skyViewLutArgs[0], skyViewLutArgs[1], skyViewLutArgs[2], skyViewLutArgs[3], skyViewLutArgs[4], skyViewLutArgs[5], skyViewLutArgs[6]);
            const aerialPerspectiveLutPipeline = AerialPerspectiveLutPipeline.create(device, aerialPerspectiveLutArgs[0], aerialPerspectiveLutArgs[1], aerialPerspectiveLutArgs[2], aerialPerspectiveLutArgs[3], aerialPerspectiveLutArgs[4], aerialPerspectiveLutArgs[5], aerialPerspectiveLutArgs[6], aerialPerspectiveLutArgs[7]);
    ...
    class SkyAtmosphereLutRenderer {
        ...
        constructor(lutRenderer, resources, skyAtmospherePipelines, defaultToPerPixelRayMarch, usesCustomUniforms, transmittanceLutPass, multiScatteringLutPass, skyViewLutPass, aerialPerspectiveLutPass) {
            if (lutRenderer) {
        ...
        static create(device, config, existingPipelines, existingResources) {
            ...
            const lutRenderer = new SkyAtmosphereLutRenderer(undefined, resources, skyAtmospherePipelines, defaultToPerPixelRayMarch, usesCustomUniforms, transmittanceLutPass, multiScatteringLutPass, skyViewLutPass, aerialPerspectiveLutPass);
    ...
    function makeSkyRenderingBindGroupLayouts(device, config, externalEntries, resources, rayMarchDistantSky, visibility) {
        const renderSkyBindGroupLayoutBaseEntries = [
            {
                binding: 0,
                visibility,
                buffer: {
    ...
    function makeSkyRenderingBindGroups(resources, withLutsLayout, rayMarchLayout, customUniforms, externalEntries, rayMarchDistantSky) {
        const renderSkyBindGroupBaseEntries = [
            {
                binding: 0,
                resource: {
                    buffer: resources.atmosphereBuffer,
     ...
     */
    class SkyAtmosphereComputeRenderer extends SkyAtmosphereLutRenderer {
        withLutsLayout;
        rayMarchLayout;
        rayMarchDistantSky;
        withLutsPass;
        rayMarchPass;
        constructor(lutRenderer, withLutsLayout, rayMarchLayout, rayMarchDistantSky, withLutsPipeline, rayMarchPipeline, config) {
            super(lutRenderer);
            this.withLutsLayout = withLutsLayout;
            this.rayMarchLayout = rayMarchLayout;
            this.rayMarchDistantSky = rayMarchDistantSky;
            ...
            this.withLutsPass = new ComputePass(withLutsPipeline, [withLutsBindGroup, ...(config.customUniformsSource?.bindGroups ?? [])], dispatchDimensions);
            this.rayMarchPass = new ComputePass(rayMarchPipeline, [
                rayMarchingBindGroup,
                ...(config.shadow?.bindGroups ?? []),
                ...(config.customUniformsSource?.bindGroups ?? []),
            ], dispatchDimensions);
        }
        static makeBindGroupLayouts(device, config, resources, rayMarchDistantSky) {
            const externalResourcesLayoutEntries = [
                {
                    binding: 5,
                    visibility: GPUShaderStage.COMPUTE,
                    texture: {
        ...
        static async createAsync(device, config, existingPipelines, existingResources) {
            ...
            return new SkyAtmosphereComputeRenderer(lutRenderer, renderSkyWithLutsBindGroupLayout, renderSkyRaymarchingBindGroupLayout, rayMarchDistantSky, renderSkyWithLutsPipeline, renderSkyRaymarchingPipeline, config);
        }
        /**
     ...
     */
    class SkyAtmosphereRasterRenderer extends SkyAtmosphereLutRenderer {
        withLutsLayout;
        rayMarchLayout;
        withLutsTargetFormats;
        rayMarchTargetFormats;
        rayMarchDistantSky;
        withLutsPass;
        withLutsBundle;
        rayMarchPass;
        rayMarchBundle;
        constructor(lutRenderer, withLutsLayout, rayMarchLayout, withLutsTargetFormats, rayMarchTargetFormats, rayMarchDistantSky, withLutsPipeline, rayMarchPipeline, config) {
            super(lutRenderer);
            this.withLutsLayout = withLutsLayout;
            this.rayMarchLayout = rayMarchLayout;
            this.withLutsTargetFormats = withLutsTargetFormats;
            this.rayMarchTargetFormats = rayMarchTargetFormats;
            this.rayMarchDistantSky = rayMarchDistantSky;
            const [withLutsBindGroup, rayMarchingBindGroup] = this.makeBindGroups(config.skyRenderer.depthBuffer.view ?? config.skyRenderer.depthBuffer.texture);
            this.withLutsPass = new RenderPass(withLutsPipeline, [withLutsBindGroup, ...(config.customUniformsSource?.bindGroups ?? [])]);
            this.rayMarchPass = new RenderPass(rayMarchPipeline, [
                rayMarchingBindGroup,
                ...(config.shadow?.bindGroups ?? []),
                ...(config.customUniformsSource?.bindGroups ?? []),
            ]);
        ...
        static makeWithLutsPiplelineDescriptor(device, config, lutRenderer, renderSkyWithLutsBindGroupLayout, blendState, dualBlendState, useDualSourceBlending) {
            ...
            if (useDualSourceBlending && !writeTransmissionOnlyOnPerPixelRayMarch) {
                ...
                code = code.replace('RenderSkyFragment(vec4(result.rgb, 1.0), vec4(vec3(result.a), 1.0))', 'RenderSkyFragment(result)');
            }
            const module = device.createShaderModule({
        ...
        static makeRayMarchPipelineDescriptor(device, config, lutRenderer, renderSkyRaymarchingBindGroupLayout, rayMarchDistantSky, blendState, dualBlendState, useDualSourceBlending) {
            ...
            if (useDualSourceBlending) {
                ...
                code = code.replace('@location(1) transmittance: vec4<f32>,', '');
                code = code.replace('RenderSkyFragment(result.luminance, result.transmittance)', 'RenderSkyFragment(vec4(result.luminance.rgb, 1.0 - dot(result.transmittance.rgb, vec3(1.0 / 3.0))))');
            }
            const module = device.createShaderModule({
        ...
        static async createAsync(device, config, existingPipelines, existingResources) {
            ...
            return new SkyAtmosphereRasterRenderer(lutRenderer, renderSkyWithLutsBindGroupLayout, renderSkyRaymarchingBindGroupLayout, withLutsFormats, rayMarchFormats, rayMarchDistantSky, renderSkyWithLutsPipeline, renderSkyRaymarchingPipeline, config);
        }
        /**
    ...
    exports.ATMOSPHERE_BUFFER_SIZE = ATMOSPHERE_BUFFER_SIZE;
    exports.ComputePass = ComputePass;
    exports.LookUpTable = LookUpTable;
    exports.RenderPass = RenderPass;
    exports.SkyAtmosphereComputeRenderer = SkyAtmosphereComputeRenderer;
    exports.SkyAtmosphereLutRenderer = SkyAtmosphereLutRenderer;
    exports.SkyAtmosphereRasterRenderer = SkyAtmosphereRasterRenderer;
    exports.SkyAtmosphereResources = SkyAtmosphereResources;
    exports.UNIFORMS_BUFFER_SIZE = UNIFORMS_BUFFER_SIZE;
    exports.atmosphereToFloatArray = atmosphereToFloatArray;
    exports.makeEarthAtmosphere = makeEarthAtmosphere;
    exports.uniformsToFloatArray = uniformsToFloatArray;

}));
//# sourceMappingURL=webgpu-sky-atmosphere.js.map
