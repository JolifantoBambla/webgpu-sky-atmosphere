...
export function makeUi() {
    ...
    renderSettingsFolder.addBinding(params.renderSettings.sun, 'direction', {picker: 'inline', expanded: true, y: {inverted: true, min: 0.0, max: 1.0}, x: {min: -1.0, max: 1.0}, label: 'Sun direction'});
